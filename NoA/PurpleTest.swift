...
struct PurpleTest: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            ZStack {
                CircleForNumbers1(progress: $progressValue)
...
//                    .shadow(color: .black, radius: 5)
                ...
                OneBigCircle1(progress: $progressValue)
                    .frame(width: 260, height: 260)
                ...
                VStack {
                    Text("178")
                        ...
                        .shadow(color: .lavenderMist, radius: 2)
                    ...
                    VStack {
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 15) {
                                ...
                                CardView1(color: Color.soap, image: "3dtarget")
                                CardView1(color: Color.soap, image: "3dtarget")
                                CardView1(color: Color.soap, image: "3dtarget")
                                CardView1(color: Color.soap, image: "3dtarget")
                                CardView1(color: Color.soap, image: "3dtarget")
...
struct OneBigCircle1: View {
    @Binding var progress: Float
    var color = Color.greenSoap
    var body: some View {
        ZStack {
            Circle()
